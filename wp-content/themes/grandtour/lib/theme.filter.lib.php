...
if(GRANDTOUR_THEMEDEMO) {
  ...
  function grandtour_remove_wp_block_library_css(){
  ...
  add_action( 'wp_enqueue_scripts', 'grandtour_remove_wp_block_library_css', 100 );
}
 ...
 * @param $options Array
 */
function grandtour_upgrade_completed( $upgrader_object, $hook_extra ) { 
   
   if ($hook_extra['type'] = 'theme' && !GRANDTOUR_THEMEDEMO) {
