...
array( "name" => "<h2>Optimisation Settings</h2>Cache theme's custom CSS",
	...
	"id" => GRANDTOUR_SHORTNAME."_advance_cache_custom_css",
	"type" => "iphone_checkboxes",
	"std" => 1
),
...
array( "name" => "<h2>Cache Settings</h2>Clear Cache",
	...
	"id" => GRANDTOUR_SHORTNAME."_advance_clear_cache",
	"type" => "html",
	"html" => '<br/><a id="'.GRANDTOUR_SHORTNAME.'_advance_clear_cache" href="'.$api_url.'" class="button">Click here to start clearing cache files</a>',
),
