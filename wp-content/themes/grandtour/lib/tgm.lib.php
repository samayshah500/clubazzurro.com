...
function grandtour_require_plugins() {
    ...
    $plugins = array(
	    array(
	        ...
	        'source'             => 'https://themegoods-assets.b-cdn.net/grandtour-custom-post/grandtour-custom-post-v2.4.1.zip',
	        'required'           => true, 
	        'version'            => '2.4.1',
	    ),
	    array(
	    ...
	    array(
			...
			'slug'               => 'revslider',
			'source'             => 'https://themegoods-assets.b-cdn.net/revslider/revslider-v6.5.31.zip',
			'required'           => true, 
			'version'            => '6.5.31',
		),
	    array(
	        'name'               => 'Booked',
	        'slug'      		=> 'booked',
	        'source'             => 'https://themegoods-assets.b-cdn.net/booked/booked-v2.3.5.zip',
	        'required'           => true, 
	        'version'            => '2.3.5',
	    ),
	    array(
