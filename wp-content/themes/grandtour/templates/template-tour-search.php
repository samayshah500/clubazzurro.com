...
{  
	...
	//$args['post_title_like'] = $_GET['keyword'];
	$args['s'] = $_GET['keyword'];
}
...
<div class="tour_search_wrapper">
	...
	<div class="tour_advance_search_wrapper">
		<div class="one_fourth themeborder">
			<select id="tourcat" name="tourcat">
				<option value=""><?php esc_html_e('All Categories', 'grandtour-translation' ); ?></option>
				<?php
		...
		<div class="one_fourth themeborder">
			<select id="destination_id" name="destination_id">
				<option value=""><?php esc_html_e('Any Destinations', 'grandtour-translation' ); ?></option>
				<?php
	...
	<div class="tour_advance_search_wrapper_link">
		<a id="tour_advance_search_toggle" class="theme_link_color" href="javascript:;"><span class="icon ti-angle-down"></span><?php esc_html_e( 'Advanced Search', 'grandtour-translation' ); ?></a>
	</div>
	<?php
		}
	?>
